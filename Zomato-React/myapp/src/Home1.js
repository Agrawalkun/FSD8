...
//   }
  return (
    ...
    <div class="main-container">
        <img src="https://b.zmtcdn.com/web_assets/81f3ff974d82520780078ba1cfbd453a1583259680.png" class="image"
            loading="lazy"/>
        <div class="navbar">
            <div class="left-nav">
                <ul class="ulist">
                    <li class="list1"> <a href=""><i class="sc-rbbb40-1 iFnyeo sc-hTQSVH elDYvD" size="10"
                                color="#FFFFFF"><svg xmlns="http://www.w3.org/2000/svg" fill="#FFFFFF" width="13"
                                    height="13" viewBox="0 0 20 20" aria-labelledby="icon-svg-title- icon-svg-desc-"
                                    role="img" class="sc-rbbb40-0 gvsUip">
                    ...
                    <NavLink to ='/Get the App'>  <li class="list1"><a href="">Get the App</a></li></NavLink>
                </ul>
            </div>
            <div class="right-nav">
                <ul>
                <NavLink to ='/Invester Realations'>   <li class="li"><a href="">Invester Realations</a></li></NavLink>
                <NavLink to ='/Add restaurant'>  <li class="li"><a href="">Add restaurant</a></li></NavLink>
                  <li className="li" >Log in</li>
                <li class="li"  onClick={() => setIsOpen(true)} id="signupOpen">Sign up</li>
               {/* <Link to="Signin"><li class="li" id="signupOpen"><a href="">Sign up</a></li></Link>  */}
                </ul>
            </div>
        </div>
        <div class="div">
            <img alt="Zomato logo" src="https://b.zmtcdn.com/web_assets/8313a97515fcb0447d2d77c276532a511583262271.png"
                class="logo"/>
            <h1 class="heading"> Discover the best food & drinks in Bhopal</h1>
            <div class="input-field">
                <div class="input">
                    <div class="icon">
                        <i class="sc-rbbb40-1 iFnyeo " color="#FF7E8B" size="20"><svg xmlns="http://www.w3.org/2000/svg"
                                fill="#FF7E8B" width="20" height="20" viewBox="0 0 20 20"
                                aria-labelledby="icon-svg-title- icon-svg-desc-" role="img" class="sc-rbbb40-0 iRDDBk">
                    ...
                    <div class="select">
                        <select name="city" id="">
                            <option value="ghg">Block B, Jayepee Greens</option>
                ...
                <div class="search">
                    <div class="search-icon icon">
                        <i class="sc-rbbb40-1 iFnyeo" color="#828282" size="18"><svg xmlns="http://www.w3.org/2000/svg"
                                fill="#828282" width="18" height="18" viewBox="0 0 20 20"
...
<div className='form-container'>
     <div class="form" id="formName">
        ...
        <div className='check'> <input type="checkbox" className='checkbox'/></div><div className='content'><span class="para-open">I agree to Zomato's</span> <span
            class="span">Terms of Services </span> <span
            class="span">Privacy  Policy</span>
          <span  class="para-opeen">and</span>
           <span class="span">Content Policies</span> </div>
           </div>
